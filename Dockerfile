...
LABEL org.opencontainers.image.title="envwrap"
LABEL org.opencontainers.image.version="0.1.0"
LABEL org.opencontainers.image.url="https://github.com/regulad/envwrap"
LABEL org.opencontainers.image.documentation="https://envwrap.readthedocs.io"
...
COPY --from=builder /code/dist/envwrap-*.whl /tmp/
RUN pip install --user /tmp/envwrap-*.whl

# Now do something!
CMD ["/home/envwrap/.local/bin/envwrap"]
